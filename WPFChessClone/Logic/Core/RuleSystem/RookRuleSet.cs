...
{
    public class RookRuleSet : RuleSet
    {
        public RookRuleSet(Board board) : base(board) { }
        public override bool isChecked(Board board)
        {
            throw new NotImplementedException("Can't call isChecked for Rook");
        }
        ...
        public override Piece.Type Type { get { return Piece.Type.Rook; } }
    }
}

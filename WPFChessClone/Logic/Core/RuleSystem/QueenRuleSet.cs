...
{
    public class QueenRuleSet : RuleSet
    {
        public QueenRuleSet(Board board) : base(board) { }
        public override bool isChecked(Board board)
        {
            throw new NotImplementedException("Can't call isChecked for Queen");
        }
        ...
        public override Piece.Type Type { get { return Piece.Type.Queen; } }
    }
}
